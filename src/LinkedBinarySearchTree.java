                                        ...
                                        implements BinarySearchTreeADT<T>
{
    ...
    /**
     * returns true if the target element is in the BST otherwise false
     * @param targetElement the element being sought in the tree
     * @return true if the target element is in the BST otherwise false
     */
    @Override
    ...
    /**
     * finds the target element if it is in the BST
     * @param targetElement the element being sought in the tree
     * @return a reference to the target element
     * @throws ElementNotFoundException if the element is not in the BST
     */
    @Override
    public T find(T targetElement) throws ElementNotFoundException{
        ...
        while(!found){
            if(null == curr){
                throw new ElementNotFoundException("Element not found in BST");
            }else if(target.compareTo(curr.getElement()) == 0){
                found = true;
            }else if(null == curr.getLeft() && null == curr.getRight()){
                throw new ElementNotFoundException("Element not found in BST");
            }
            else{
                if(target.compareTo(curr.getElement()) < 0){
                      curr = curr.getLeft();
                }else{
                    curr = curr.getRight();
                }
