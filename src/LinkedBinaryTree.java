...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
     ...
     public int getHeight()
    {
        ...
        int rightHeight = 0;
        if(!isEmpty()){
            if(null != getRight() && !getRight().isEmpty()){
                rightHeight = height(getRight().getRootNode());
            }
            if(null != getLeft() && !getLeft().isEmpty()){
                leftHeight= height(getLeft().getRootNode());
            }
     ...
     */
    @Override
    public Iterator<T> iteratorPostOrder()throws UnsupportedOperationException
    {
